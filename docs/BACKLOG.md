...
| ID      | Ticket                                                                       | Status |
| ------- | ---------------------------------------------------------------------------- | ------ |
| WOP-101 | Create endpoint and destination records with secret-safe setup UX. GitHub #3 | active |
...
| ID      | Ticket                                                                                | Status |
| ------- | ------------------------------------------------------------------------------------- | ------ |
| WOP-301 | Complete filters, attempt detail, copyable diagnostics, and recovery feedback         | todo   |
| WOP-302 | Add deterministic demo modes and guarded reset                                        | todo   |
